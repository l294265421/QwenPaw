...
Vendored from Hermes Agent ``tools/skills_guard.py`` for QwenPaw
``hermes_auto_skill`` so workspace skills do not depend on
...
Usage:
    from qwenpaw.extensions.hermes_auto_skill.skills_guard import (
        scan_skill,
...
class SkillScanBlocked(RuntimeError):
    """Raised when :func:`scan_skill` blocks installation under policy."""
